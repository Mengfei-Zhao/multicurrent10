...
class GUI_LoadParam(object):
    ...
    def _glp_loadSetCurr(self, dataInFile):
        ...
        self.doubleSpinBox_2.setValue(float(dataInFile[24]))
        self.doubleSpinBox_3.setValue(float(dataInFile[25]))
        self.doubleSpinBox_4.setValue(float(dataInFile[26]))
        self.doubleSpinBox_5.setValue(float(dataInFile[27]))
        self.doubleSpinBox_6.setValue(float(dataInFile[28]))
        self.doubleSpinBox_7.setValue(float(dataInFile[29]))
        self.doubleSpinBox_8.setValue(float(dataInFile[30]))
        self.doubleSpinBox_9.setValue(float(dataInFile[31]))
        self.doubleSpinBox_10.setValue(float(dataInFile[32]))
