...
"")
        ...
        self.label_19.setGeometry(QtCore.QRect(480, 790, 197, 140))
        self.label_19.setText("")
        self.label_19.setObjectName("label_19")
        self.label_20 = QtWidgets.QLabel(self.centralwidget)
        self.label_20.setGeometry(QtCore.QRect(10, 875, 221, 22))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_21.setGeometry(QtCore.QRect(235, 865, 51, 51))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("f:\\Python_Prj\\SIMIT\\SFQ_IbCtrl\\currentSupply\\icons/max_curr.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionSet_max_current_for_channels.setIcon(icon4)
        self.actionSet_max_current_for_channels.setObjectName("actionSet_max_current_for_channels")
        self.actionReconnect_to_multicurrent10 = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("f:\\Python_Prj\\SIMIT\\SFQ_IbCtrl\\currentSupply\\icons/connected.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionReconnect_to_multicurrent10.setIcon(icon5)
        self.actionReconnect_to_multicurrent10.setObjectName("actionReconnect_to_multicurrent10")
        self.actionDisconnect_multicurrent10 = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("f:\\Python_Prj\\SIMIT\\SFQ_IbCtrl\\currentSupply\\icons/disconnected.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionDisconnect_multicurrent10.setIcon(icon6)
        self.actionDisconnect_multicurrent10.setObjectName("actionDisconnect_multicurrent10")
        self.actionInfo_of_connection = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("f:\\Python_Prj\\SIMIT\\SFQ_IbCtrl\\currentSupply\\icons/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionInfo_of_connection.setIcon(icon7)
        self.actionInfo_of_connection.setObjectName("actionInfo_of_connection")
        ...
        self.menuSetting.addAction(self.actionReconnect_to_multicurrent10)
        self.menuSetting.addSeparator()
        self.menuSetting.addAction(self.actionInfo_of_connection)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionReconnect_to_multicurrent10.setText(_translate("MainWindow", "Reconnect to multicurrent10"))
        self.actionDisconnect_multicurrent10.setText(_translate("MainWindow", "Disconnect multicurrent10"))
        self.actionInfo_of_connection.setText(_translate("MainWindow", "Info of connection"))
import icons_rc
